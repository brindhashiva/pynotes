...
AUTHOR          = 'Brindha'  # use your name
SITENAME        = 'My Python Notes' # use title
GITHUB_USERNAME = 'brindhashiva' # use your username
...
# Social widget
SOCIAL = (
    ("GitHub", "https://github.com/brindhashiva/"),
    ("LinkedIn", "www.linkedin.com/in/brindha-shiva"),
)
